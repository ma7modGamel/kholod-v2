...
use App\Filament\Employee\Resources\MyLeaveRequestsResource\Pages;
use App\Filament\Employee\Resources\MyLeaveRequestsResource\RelationManagers;
...
class MyLeaveRequestsResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            // 'create' => Pages\CreateMyLeaveRequests::route('/create'),
            // 'edit' => Pages\EditMyLeaveRequests::route('/{record}/edit'),
        ];
    }
}