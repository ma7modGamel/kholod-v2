...
namespace App\Filament\Employee\Resources\CorrespondenceResource\Pages;
...
class ViewCorrespondence extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            ->visible(fn ($record) => 
            $record->trackings->isNotEmpty() && 
            (!$record->check_user_make_referral() || 
             $record->trackings->last()->to_user_id == auth()->id()) && 
            !$record->finished && 
            $record->trackings->last()->type == 'person'
