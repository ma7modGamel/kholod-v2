...
use App\Filament\Admin\Resources\ContractorResource\Pages;
use App\Filament\Admin\Resources\ContractorResource\RelationManagers;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('manger_name')
                    ->searchable()->label('اسم المدير'),
                Tables\Columns\TextColumn::make('manger_phone')
                    ->searchable()->label('رقم المدير'),
